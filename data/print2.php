...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>Grand Emporium,</p>
				<p>Harmoni Street,<br>Serenity,<br>Dream Land.</p>
				<p>(+62) 81 987 654 321</p>
			</address>
			<span>Grand Emporium</span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email : info@grandemporiumhotel-id.com | Web : grandemporium.com | Phone : +62 81 987 654 321  </p>
			</div>
		</aside>
	</body>
</html>
