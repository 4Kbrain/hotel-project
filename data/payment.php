    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="beranda.php"><?php echo $_SESSION["user"]; ?> </a>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="usersetting.php">> User Profile</a>
                        </li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="messages.php"> News Letters</a>
                    </li>
					<li>
                        <a href="roombook.php">Room Booking</a>
                    </li>
                    <li>
                        <a class="active-menu" href="payment.php"> Payment</a>
                    </li>
                    <li>
