...
$sql = "SELECT * FROM reservation WHERE NIK = '$NIK' AND (status = 'Pending' OR status = 'Booked')";
...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "</div>";
            echo '<div class="bottom-navbar">';
            echo '<a href="reservation_form.php" class="navbar-item-active">Reservation</a>';
            echo '<span class="navbar-divider">|</span>';
            echo '<a href="myreservation.php" class="navbar-item">My Reservation</a>';
        echo '</div>';
        }
    } else {
