...
if ($conn->query($sql_update_reservation) === TRUE) {
    ...
    if ($conn->query($sql_update_kamar) === TRUE) {
        ...
        echo "Error updating kamar table: " . $conn->error;
    }
} else {
    echo "Error updating reservation table: " . $conn->error;
}
