...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fetch the id of the selected room from the kamar table
    $get_kamar_id_sql = "SELECT id FROM kamar WHERE type_room = ?";
    $get_kamar_id_stmt = $conn->prepare($get_kamar_id_sql);
    $get_kamar_id_stmt->bind_param("s", $troom);
    $get_kamar_id_stmt->execute();
    $get_kamar_id_result = $get_kamar_id_stmt->get_result();
