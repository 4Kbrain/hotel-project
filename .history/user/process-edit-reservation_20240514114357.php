...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($payment >= $total_cost) {
        ...
        try {
            ...
            $insert_transaction_sql = "INSERT INTO transactions (id_reservation, id_kamar, NIK, nama, email, troom, bed, nroom, nodays, cin, cout, payment, total_cost, kembalian,status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,'')";
