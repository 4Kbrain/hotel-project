...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($reservation_result->num_rows > 0) {
        ...
        if ($payment >= $total_cost) {
            ...
            $insert_transaction_sql = "INSERT INTO transactions (NIK, nama, payment, total_cost, cin, cout) SELECT NIK, CONCAT(fname, ' ', lname), '$payment', total_cost, cin, cout FROM reservation WHERE id='$id'";
