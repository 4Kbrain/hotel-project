...
$sql = "SELECT * FROM transactions WHERE id_reservatuib = '$NIK' AND (status = 'Waiting For Approval' OR status = 'Paid')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    WHERE id='$id'";
            ...
            $sss = "SELECT * FROM transactions WHERE id = $ids";
            header("Location: action/print_invoice.php?id=$sss");
            exit();
        } else {
            header("Location: edit-transaction.php?id=$id");
