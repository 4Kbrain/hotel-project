...
$sql = "SELECT * FROM `reservation` JOIN kamar ON reservation.id_kamar = kamar.id_kamar JOIN transactions ON reservation.id_kamar=kamar.id_kamar WHERE status='Booked'";
