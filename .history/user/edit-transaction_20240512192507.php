...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($payment >= $total_cost) {
        ...
        $stmt_reservation = $con->prepare("UPDATE reservation SET payment=?, total_cost=?, kembalian=? WHERE id=?");
...
<body>
    ...
    <form method="post" action="edit-transaction.php" class="container">
        ...
        <input type="text" id="payment" name="payment" value="<?php echo htmlspecialchars($payment); ?>" oninput="calculateChange()"><br>
        <label for="total_cost">Total Cost:</label><br>
        <input type="text" id="total_cost" name="total_cost" value="<?php echo htmlspecialchars($total_cost); ?>"><br>
