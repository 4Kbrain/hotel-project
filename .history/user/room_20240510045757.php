...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add_room'])) {
        ...
        $room_status = $_POST['room_statu'];
        $room_capacity = $_POST['room_capacity'];

        $sql = "INSERT INTO kamar (NULL, type_room, room_status, room_capacity) VALUES ('$room_name', '$room_status', '$room_capacity')";
        ...
        $sql = "UPDATE rooms SET room_status='$room_status' WHERE id='$room_id'";
        if ($conn->query($sql) === TRUE) {
