...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_fetch_total_cost = $con->prepare("SELECT total_cost AND FROM reservation WHERE id=?");
...
<body>
    ...
    <form method="post" action="edit-transaction.php" class="container">
        ...
        <input type="text" id="NIK" name="NIK" value="<?php echo htmlspecialchars($NIK) ?>"><br>
