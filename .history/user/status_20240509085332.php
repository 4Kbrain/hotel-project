...
$sql = "SELECT * FROM reservation WHERE status = 'Waiting For Approval'";
...
<body>
            ...
            <table class="pembayaran-table">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='edit-transaction.php?id=" . $row["id"] . "'>Edit</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
    ...
    <script>
        ...
        function confirmUpdate(id) {
            ...
            window.location.href = "edit-transaction.php?id=" + id + "&status=" + status;
        }
        function confirmUpdate(id) {
