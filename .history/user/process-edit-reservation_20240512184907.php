...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($payment >= $total_cost) {
        ...
        $update_sql = "UPDATE reservation SET id_kamar='$id_kamar', NIK='$NIK', fname='$fname', lname='$lname', email='$email', phone='$phone', troom='$troom', bed='$bed', nroom='$nroom', cin='$cin', cout='$cout', status='Booked', nodays='$nodays', payment='$payment', total_cost='$total_cost', change='$change' WHERE id='$id'";
        if ($conn->query($update_sql) === TRUE) {
            // Update history table
            $update_history_sql = "UPDATE history SET id_kamar='$id_kamar', NIK='$NIK', fname='$fname', lname='$lname', email='$email', phone='$phone', troom='$troom', bed='$bed', nroom='$nroom', cin='$cin', cout='$cout', status='Booked', nodays='$nodays', payment='$payment', total_cost='$total_cost', change='$change' WHERE id_reservation='$id'";
