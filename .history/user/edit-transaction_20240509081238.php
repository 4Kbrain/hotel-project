...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_sql = "INSERT INTO transactions (NIK, nama, total_cost, cin, cout) SELECT NIK, CONCAT(fname, ' ', lname), total_cost, cin, cout, '$currency' FROM reservation WHERE id='$id'";
