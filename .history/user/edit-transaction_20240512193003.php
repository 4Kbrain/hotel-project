...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Debugging: Check if total_cost is fetched successfully
    if ($total_cost !== null) {
        echo "Total cost fetched successfully: " . $total_cost;
    } else {
        echo "Error fetching total cost from reservation table.";
    }
