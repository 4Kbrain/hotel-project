        ...
        <table class="pembayaran-table">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<option>value='Approved'" . ($row["Approved"] == "Approved" ? "Selected : ")"<a class='action-link' href='edit-transaction.php?id=" . $row["id"] . "' target='_blank'>Print Invoice</a></option>";
