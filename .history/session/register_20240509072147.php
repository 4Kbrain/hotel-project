...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($mygmail === 'aditgaming105@gmail.com') {
        $is_admin = 1; // If the email matches, set is_admin to 1
    } else {
        $is_admin = 0;
    }
    ...
    if ($check_result) {
        if (mysqli_num_rows($check_result) > 0) {
            ...
            $sql = "INSERT INTO users (gmail, password, is_admin) VALUES ('$mygmail', '$hashed_password', '$is_admin')";
