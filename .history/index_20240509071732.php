...
if(isset($_SESSION['NIK'])) {
   ...
   $stmt = $con->prepare("INSERT INTO review (NIK, bintang, review) VALUES (?, ?, ?)");
   $stmt->bind_param("iis", $NIK, $_POST['bintang'], $_POST['review']);
...
<body>
   ...
   <header class="header">
      ...
      <nav class="navbar">
         ...
         if (isset($_SESSION['user'])) {
            $_SESSION['NIK'] = $_SESSION['User'];
            // Unset the old session variable 'User'
            unset($_SESSION['User']);
            
            // Display a message indicating the change
            echo "Session variable 'User' has been changed to 'NIK'.";
   ...
   <section class="location" id="location">
      <iframe
         src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.3881153611287!2d110.35409697595544!3d-7.854386778068241!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5640c272c36b%3A0xc74f6e44ceb0382c!2sIwan%20Motor!5e0!3m2!1sid!2sid!4v1698632094363!5m2!1sid!2sid"
         ...
         <div class="row">
            <div class="footer-col">
               ...
               <div class="social-links">
                  <a href="https://www.facebook.com/GrandEmporiumHotel" target="_blank"><i
                        class="fab fa-facebook"></i></a>
                  <a href="https://twitter.com/GrandEmporium" target="_blank"><i class="fab fa-twitter"></i></a>
                  <a href="https://www.instagram.com/grandemporiumhotel" target="_blank"><i
                        class="fab fa-instagram"></i></a>
                  <a href="https://api.whatsapp.com/send?phone=+123" target="_blank"><i class="fab fa-whatsapp"></i></a>
               </div>
            </div>
            <div class="footer-col">
               <h4>Our Company</h4>
            ...
            <div class="footer-col">
               ...
               <ul>
                  <li>
                     <a href="#"><i class="fa-solid fa-map"></i>45 Harmoni Street, Serenity
                        Town, Bliss City, 56789, Dreamland</a>
                  </li>
                  <li><a href="#"><i class="fa-solid fa-phone"></i>+6281987654321</a></li>
                  <li>
                     <a href="mailto:info@grandemporiumhotel-id.com"><i
                           class="fa-solid fa-envelope"></i>info@grandemporiumhotel-id.com</a>
                  </li>
                  <li><a href="#"></a></li>
               </ul>
            </div>
   ...
   <script src="src/js/live-rating.js"></script>
